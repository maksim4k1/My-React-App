...
const store = {
    ...
    // Users
    users: [
        {id: 0, username: "maksim4k1", password: "1234", email: "maksim4k1@gmail.com", name: "Баженов Максим", deskription: "Здравствуйте, я начинающий Front-end разработчик. Мои ключевые навыки: JavaScript, React, TypeScript, HTML, CSS.", hobby: "Web-разработка", website: "https://github.com/maksim4k1", image: "https://i.pinimg.com/originals/a7/3d/6e/a73d6e4ac85c6a822841e449b24c78e1.jpg" },
        {id: 1, username: "Sasha", password: "1234", email: "sasha@gmail.com", name: "Pak Sasha", deskription: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, nesciunt?", hobby: "Создавать калькуляторы на Python и Web-разработка", website: "", image: "https://images.ctfassets.net/hrltx12pl8hq/3MbF54EhWUhsXunc5Keueb/60774fbbff86e6bf6776f1e17a8016b4/04-nature_721703848.jpg?fit=fill&w=480&h=270" },
        {id: 2, username: "Ilya", password: "1234", email: "ilya@gmail.com", name: "Fomin Ilya", deskription: "Name: Илья, Sex: Не было", hobby: "Android-разработка", website: "", image: "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" },
        {id: 3, username: "Isa", password: "1234", email: "isa@gmail.com", name: "Maratov Isa", deskription: `Глава компании "Строй компания ЗАО «Марат Строй»"`, hobby: "Руководить", website: "", image: "https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg" },
        ...
        {id: 6, username: "Egor", password: "1234", email: "egor@gmail.com", name: "Bazhenov Egor", deskription: "Смотреть фильмы", hobby: "Драчу писю пока Максим спит.", website: "", image: "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" },
